package com.adosa.opensrp.chw.household;
...
public class PathfinderModelHouseholdLibrary {
    private static PathfinderModelHouseholdLibrary instance;
    ...
    private PathfinderModelHouseholdLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new PathfinderModelHouseholdLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static PathfinderModelHouseholdLibrary getInstance() {
        if (instance == null) {
