...
import com.adosa.opensrp.chw.household.custom_views.BaseModelHouseholdFloatingMenu;
...
import com.adosa.opensrp.chw.household.presenter.BasePathfinderModelHouseholdProfilePresenter;
...
public class BasePathfinderModelHouseholdProfileActivity extends BaseProfileActivity implements BaseModelHouseholdProfileContract.View {
    ...
    protected BaseModelHouseholdProfileContract.Presenter fpProfilePresenter;
    protected BaseModelHouseholdFloatingMenu fpFloatingMenu;
    protected PathfinderModelHouseholdMemberObject pathfinderModelHouseholdMemberObject;
    ...
    public static void startProfileActivity(Activity activity, PathfinderModelHouseholdMemberObject memberObject) {
        Intent intent = new Intent(activity, BasePathfinderModelHouseholdProfileActivity.class);
        intent.putExtra(PathfinderModelHouseholdConstants.FamilyPlanningMemberObject.MEMBER_OBJECT, memberObject);
    ...
    protected void onCreation() {
        ...
        toolbar.setNavigationOnClickListener(v -> BasePathfinderModelHouseholdProfileActivity.this.finish());
        appBarLayout = this.findViewById(R.id.collapsing_toolbar_appbarlayout);
        if (Build.VERSION.SDK_INT >= 21) {
            appBarLayout.setOutlineProvider(null);
        }

        pathfinderModelHouseholdMemberObject = (PathfinderModelHouseholdMemberObject) getIntent().getSerializableExtra(PathfinderModelHouseholdConstants.FamilyPlanningMemberObject.MEMBER_OBJECT);
    ...
    protected void initializePresenter() {
        fpProfilePresenter = new BasePathfinderModelHouseholdProfilePresenter(this, new BasePathfinderModelHouseholdProfileInteractor(), pathfinderModelHouseholdMemberObject);
    }

    public void initializeCallFAB() {
        if (StringUtils.isNotBlank(pathfinderModelHouseholdMemberObject.getPhoneNumber())
                || StringUtils.isNotBlank(pathfinderModelHouseholdMemberObject.getFamilyHeadPhoneNumber())) {
            fpFloatingMenu = new BaseModelHouseholdFloatingMenu(this, pathfinderModelHouseholdMemberObject);
...
//        }
    ...
    public void setUpComingServicesStatus(String service, AlertStatus status, Date date) {
        ...
        if (status == AlertStatus.upcoming) {
            tvUpComingServices.setText(ModelHouseholdUtil.fromHtml(getString(R.string.pathfinder_fp_service_upcoming, service, dateFormat.format(date))));
        } else {
            tvUpComingServices.setText(ModelHouseholdUtil.fromHtml(getString(R.string.pathfinder_fp_service_due, service, dateFormat.format(date))));
        }
    }
    ...
    public void setFamilyStatus(AlertStatus status) {
        ...
        if (status == AlertStatus.complete) {
            ...
            tvFamilyStatus.setText(ModelHouseholdUtil.fromHtml(getString(R.string.pathfinder_family_has_service_overdue)));
        }
    }

    @Override
    public void setProfileViewDetails(PathfinderModelHouseholdMemberObject pathfinderModelHouseholdMemberObject) {
        int age = new Period(new DateTime(pathfinderModelHouseholdMemberObject.getAge()), new DateTime()).getYears();
        tvName.setText(String.format(Locale.getDefault(), "%s %s %s, %d", pathfinderModelHouseholdMemberObject.getFirstName(),
                pathfinderModelHouseholdMemberObject.getMiddleName(), pathfinderModelHouseholdMemberObject.getLastName(), age));


        if (pathfinderModelHouseholdMemberObject.getGender().equals("Male")) {
        ...
        tvLocation.setText(pathfinderModelHouseholdMemberObject.getAddress());
        tvUniqueID.setText(pathfinderModelHouseholdMemberObject.getUniqueId());
        imageRenderHelper.refreshProfileImage(pathfinderModelHouseholdMemberObject.getBaseEntityId(), profileImageView, ModelHouseholdUtil.getMemberProfileImageResourceIDentifier());

        if (StringUtils.isNotBlank(pathfinderModelHouseholdMemberObject.getFamilyHead()) && pathfinderModelHouseholdMemberObject.getFamilyHead().equals(pathfinderModelHouseholdMemberObject.getBaseEntityId())) {
            findViewById(R.id.fp_family_head).setVisibility(View.VISIBLE);
        }
        if (StringUtils.isNotBlank(pathfinderModelHouseholdMemberObject.getPrimaryCareGiver()) && pathfinderModelHouseholdMemberObject.getPrimaryCareGiver().equals(pathfinderModelHouseholdMemberObject.getBaseEntityId())) {
    ...
    @Override
    public void onMemberDetailsReloaded(PathfinderModelHouseholdMemberObject pathfinderModelHouseholdMemberObject) {
        setupViews();
        fetchProfileData();
        fpProfilePresenter.refreshProfileFpStatusInfo();
    }
