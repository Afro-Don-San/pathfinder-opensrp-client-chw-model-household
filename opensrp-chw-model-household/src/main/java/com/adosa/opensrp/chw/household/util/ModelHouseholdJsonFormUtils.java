...
public class ModelHouseholdJsonFormUtils extends org.smartregister.util.JsonFormUtils {
    ...
    public static Event processJsonForm(AllSharedPreferences allSharedPreferences, String
        ...
        String entityId = getString(jsonForm, ModelHouseholdJsonFormUtils.ENTITY_ID);
        String encounter_type = jsonForm.optString(ModelHouseholdJsonFormUtils.ENCOUNTER_TYPE);
    ...
    protected static FormTag formTag(AllSharedPreferences allSharedPreferences) {
        ...
        formTag.appVersion = PathfinderModelHouseholdLibrary.getInstance().getApplicationVersion();
        formTag.databaseVersion = PathfinderModelHouseholdLibrary.getInstance().getDatabaseVersion();
        return formTag;
    }
    ...
    public static void tagEvent(AllSharedPreferences allSharedPreferences, Event event) {
        ...
        event.setClientApplicationVersion(PathfinderModelHouseholdLibrary.getInstance().getApplicationVersion());
        event.setClientDatabaseVersion(PathfinderModelHouseholdLibrary.getInstance().getDatabaseVersion());
    }
    ...
    public static JSONObject getFormAsJson(String formName) throws Exception {
        return FormUtils.getInstance(PathfinderModelHouseholdLibrary.getInstance().context().applicationContext()).getFormJson(formName);
    }
